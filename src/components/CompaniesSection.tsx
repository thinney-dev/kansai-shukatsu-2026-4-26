...
const CompaniesSection = () => {
  ...
  const companies = [
    ...
    { 
      ...
      name: "オースビー",    
      tags: ["組織変革", "経営・業務改革"],    
      logoImage: "/logo-Aus.png",   
      url: "https://www.aus-be.jp/",   
      details: {   
        catchphrase: "人・組織の変革から企業の本質的な課題解決を担う、ビジネスエンジニアリング会社",  
        stats: [  
          { label: "売上高", value: "26億3,200万円（2024年11月〜2025年10月実績）" },  
          { label: "経常利益", value: "4億1,100万円（2024年11月〜2025年10月実績）" },   
          { label: "社員数", value: "160名" },   
          { label: "設立", value: "2007年2月1日" }  
        ],  
        strength: "オースビーは、企業の経営・事業・業務の課題を、表面的な提案で終わらせず、人・組織の変革まで踏み込んで支援する『ビジネスエンジニアリング』を中核事業とする会社です。公式サイトでは、企業経営の問題は人・組織の問題に帰着すると位置づけ、経営・事業推進、業務改革、プロジェクト推進、情報システム開発・導入、人材教育・管理者育成などを一体で支援すると説明しています。大手企業の改革案件や業務・組織変革案件にも携わっており、若手のうちから企業の本質的な課題に向き合いたい人、論理だけでなく現場に入り込んで変革を実行したい人に向いた環境です。"  
      }   
    },
  ];
