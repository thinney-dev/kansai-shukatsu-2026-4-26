  ...
  return (
    <section className="py-8 px-4 relative z-10">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="block bg-gradient-to-br from-white to-purple-50/30 border border-[#B8860B]/30 shadow-sm rounded-2xl p-8 md:p-10 relative overflow-hidden mb-8">
